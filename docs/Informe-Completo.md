...
En el Perú, el ecosistema de las Micro y Pequeñas Empresas —MYPE— constituye uno de los principales motores de la economía nacional, debido a que representa el 99.1% de las empresas formales del país y concentra gran parte del empleo privado. Según el Ministerio de la Producción, en 2024 las MYPE representaron el 99.1% del total de empresas registradas y emplearon el 86.5% del empleo total del sector privado formal (PRODUCE, 2025). Asimismo, ComexPerú señala que, en 2024, las MYPE representaron el 99.7% de las empresas peruanas, emplearon al 45.2% de la PEA y registraron una informalidad del 86.8%, lo cual evidencia una estructura empresarial altamente vulnerable y con limitadas capacidades de formalización (ComexPerú, 2025).

Dentro de este sector, rubros como la gastronomía, el comercio minorista y los servicios eventuales enfrentan problemas asociados a la informalidad, baja productividad y limitada capacidad de gestión. En el caso de las MYPE, PRODUCE reportó que la informalidad en la microempresa alcanzó el 91.3% y en la pequeña empresa el 48.3% durante 2022; además, el sector comercio presentó una informalidad de 89.3%, lo que confirma la alta precariedad en actividades vinculadas al comercio y servicios urbanos (PRODUCE, 2023).

El problema central radica en la ineficiencia, lentitud y desconfianza en el proceso de contratación para turnos eventuales o trabajos de emergencia. Cuando un restaurante se queda sin personal durante un horario de alta demanda o una bodega requiere apoyo para inventarios, los dueños suelen depender de mecanismos informales como recomendaciones personales, contactos directos o avisos físicos, lo que genera pérdida de tiempo, baja trazabilidad y riesgos operativos. Esta situación se relaciona con las limitadas capacidades de gestión de muchas MYPE, pues ComexPerú reporta que el 76.5% de estas no lleva ningún registro de cuentas y que una proporción importante de su fuerza laboral está compuesta por familiares del dueño, lo cual refleja una gestión empresarial poco estructurada (ComexPerú, 2025).

Por otro lado, existe un amplio sector de jóvenes, especialmente estudiantes universitarios y técnicos, que busca generar ingresos sin abandonar sus estudios. Sin embargo, enfrentan barreras como la exigencia de experiencia previa, la escasez de oportunidades formales y los horarios laborales extensos. Un estudio sobre empleabilidad juvenil en Lima identificó que, desde la perspectiva de los empleadores, la falta de experiencia laboral es la principal razón por la cual los jóvenes no acceden a empleos formales, con un 47.7%; mientras que los propios jóvenes también reconocen la falta de experiencia como una de sus principales barreras, con un 30.7% (Arcos Dorados, 2025).
...
| Story ID | Título | Descripción | Criterios de Aceptación |
|----------|--------|-------------|--------------------------|
| US06 | Registro de contratante | Como contratante, quiero registrarme mediante un formulario simple con los datos de mi negocio, para publicar turnos y gestionar personal eventual desde la plataforma. | Escenario 1: Registro exitoso.<br>Dado que el contratante ingresa todos los datos obligatorios correctamente<br>Cuando confirma el registro<br>Entonces el sistema crea la cuenta y muestra un mensaje de registro exitoso.<br><br>Escenario 2: Registro con datos inválidos.<br>Dado que el contratante ingresa datos incompletos o inválidos<br>Cuando intenta confirmar el registro<br>Entonces el sistema muestra un mensaje de error indicando los campos que deben corregirse. |
| US07 | Publicar turnos | Como contratante, quiero publicar turnos laborales indicando puesto, horario, ubicación y pago, para cubrir necesidades de personal de manera rápida. | Escenario 1: Publicación exitosa.<br>Dado que el contratante completa todos los datos requeridos del turno<br>Cuando selecciona la opción de publicar<br>Entonces el sistema registra el turno y lo muestra como disponible para los chambeadores.<br><br>Escenario 2: Publicación con datos incompletos.<br>Dado que el contratante deja campos obligatorios vacíos<br>Cuando intenta publicar el turno<br>Entonces el sistema muestra un mensaje de error solicitando completar la información faltante. |
| US08 | Ver trabajadores cercanos | Como contratante, quiero visualizar chambeadores cercanos a la ubicación del negocio, para contactar o seleccionar personal disponible rápidamente. | Escenario 1: Trabajadores disponibles.<br>Dado que existen chambeadores cercanos y disponibles<br>Cuando el contratante accede a la sección de trabajadores cercanos<br>Entonces el sistema muestra una lista con sus perfiles, habilidades, disponibilidad y reputación.<br><br>Escenario 2: Sin trabajadores disponibles.<br>Dado que no existen chambeadores disponibles cerca de la ubicación del negocio<br>Cuando el contratante accede a la sección de trabajadores cercanos<br>Entonces el sistema muestra un mensaje indicando que no hay trabajadores disponibles por el momento. |
| US09 | Seleccionar trabajador | Como contratante, quiero seleccionar chambeadores considerando su reputación, habilidades y disponibilidad, para asignar el trabajador más adecuado al turno publicado. | Escenario 1: Selección exitosa.<br>Dado que el chambeador se encuentra disponible para el turno<br>Cuando el contratante selecciona al trabajador<br>Entonces el sistema asigna el turno al chambeador y muestra una confirmación de selección.<br><br>Escenario 2: Trabajador no disponible.<br>Dado que el chambeador ya fue asignado a otro turno o no se encuentra disponible<br>Cuando el contratante intenta seleccionarlo<br>Entonces el sistema muestra un mensaje indicando que el trabajador ya no está disponible. |
| US10 | Cubrir turno rápido | Como contratante, quiero cubrir turnos urgentes en el menor tiempo posible, para evitar pérdidas operativas por falta de personal. | Escenario 1: Cobertura exitosa del turno.<br>Dado que el contratante publica un turno urgente<br>Cuando un chambeador disponible acepta o postula al turno<br>Entonces el sistema confirma la cobertura del turno y notifica al contratante.<br><br>Escenario 2: Turno sin postulantes dentro del tiempo límite.<br>Dado que el turno urgente no recibe postulantes dentro del tiempo establecido<br>Cuando se cumple el tiempo límite de espera<br>Entonces el sistema notifica al contratante que el turno aún no ha sido cubierto. |
...
| Story ID | Título | Descripción | Criterios de Aceptación |
|----------|--------|-------------|--------------------------|
| US11 | Chat interno | Como usuario, quiero comunicarme mediante un chat interno dentro de la plataforma, para coordinar detalles del turno aceptado de manera rápida y segura. | Escenario 1: Chat disponible para turno aceptado.<br>Dado que un turno ha sido aceptado por un chambeador<br>Cuando el chambeador o el contratante acceden al detalle del turno<br>Entonces el sistema habilita el chat interno para que ambos puedan intercambiar mensajes.<br><br>Escenario 2: Chat no disponible sin turno aceptado.<br>Dado que el turno aún no ha sido aceptado o no existe una relación laboral confirmada<br>Cuando el usuario intenta acceder al chat<br>Entonces el sistema bloquea el acceso y muestra un mensaje indicando que el chat estará disponible cuando el turno sea aceptado. |
| US12 | Calificación de usuarios | Como usuario, quiero calificar la experiencia después de un turno finalizado, para fortalecer la reputación y confianza dentro de la plataforma. | Escenario 1: Calificación registrada correctamente.<br>Dado que el turno ha finalizado correctamente<br>Cuando el usuario registra una calificación y comentario sobre la experiencia<br>Entonces el sistema guarda la calificación y actualiza la reputación del usuario calificado.<br><br>Escenario 2: Calificación fuera del periodo permitido.<br>Dado que el usuario intenta calificar después del tiempo límite establecido<br>Cuando envía la calificación<br>Entonces el sistema rechaza la acción y muestra un mensaje indicando que el periodo de calificación ha expirado. |
...
| Story ID | Título | Descripción | Criterios de Aceptación |
|----------|--------|-------------|--------------------------|
| US13 | Ver trabajos en mapa | Como chambeador, quiero visualizar los trabajos disponibles en un mapa, para identificar oportunidades laborales cercanas a mi ubicación de manera rápida. | Escenario 1: Mapa con trabajos disponibles.<br>Dado que existen trabajos disponibles cerca de la ubicación del chambeador<br>Cuando el chambeador accede a la vista de mapa<br>Entonces el sistema muestra los trabajos disponibles mediante marcadores en el mapa.<br><br>Escenario 2: Mapa sin trabajos disponibles.<br>Dado que no existen trabajos disponibles en la zona consultada<br>Cuando el chambeador accede a la vista de mapa<br>Entonces el sistema muestra un mensaje indicando que no hay trabajos disponibles por el momento. |
| US14 | Filtrar por distancia | Como chambeador, quiero filtrar los trabajos disponibles por distancia, para encontrar oportunidades laborales cercanas y reducir el tiempo de traslado. | Escenario 1: Filtro por distancia aplicado correctamente.<br>Dado que el chambeador selecciona un rango de distancia<br>Cuando aplica el filtro<br>Entonces el sistema muestra únicamente los trabajos que se encuentran dentro del rango seleccionado.<br><br>Escenario 2: Sin resultados dentro del rango.<br>Dado que no existen trabajos disponibles dentro de la distancia seleccionada<br>Cuando el chambeador aplica el filtro<br>Entonces el sistema muestra un mensaje indicando que no se encontraron trabajos cercanos. |
| US15 | Filtrar por tipo | Como chambeador, quiero filtrar los trabajos disponibles por tipo de actividad, para encontrar turnos que se ajusten a mis habilidades e intereses. | Escenario 1: Filtro por tipo aplicado correctamente.<br>Dado que el chambeador selecciona un tipo de trabajo disponible<br>Cuando aplica el filtro<br>Entonces el sistema muestra los trabajos que coinciden con el tipo seleccionado.<br><br>Escenario 2: Sin coincidencias por tipo de trabajo.<br>Dado que no existen trabajos disponibles del tipo seleccionado<br>Cuando el chambeador aplica el filtro<br>Entonces el sistema muestra un mensaje indicando que no hay trabajos relacionados con ese tipo de actividad. |
| US16 | Lista de trabajos | Como chambeador, quiero visualizar una lista de trabajos disponibles, para revisar las oportunidades laborales de forma ordenada y seleccionar la más conveniente. | Escenario 1: Lista de trabajos visible.<br>Dado que existen trabajos disponibles en la plataforma<br>Cuando el chambeador accede a la sección de trabajos<br>Entonces el sistema muestra una lista con información básica como título, ubicación, horario, pago y tipo de trabajo.<br><br>Escenario 2: Lista de trabajos vacía.<br>Dado que no existen trabajos disponibles en ese momento<br>Cuando el chambeador accede a la sección de trabajos<br>Entonces el sistema muestra un mensaje indicando que no hay trabajos disponibles por ahora. |
| US17 | Guardar favoritos | Como chambeador, quiero guardar trabajos como favoritos, para revisarlos posteriormente antes de aceptar o postular a un turno. | Escenario 1: Trabajo guardado correctamente.<br>Dado que el chambeador selecciona un trabajo disponible<br>Cuando elige la opción de guardar como favorito<br>Entonces el sistema registra el trabajo en su lista de favoritos y muestra una confirmación.<br><br>Escenario 2: Trabajo ya guardado previamente.<br>Dado que el trabajo ya se encuentra registrado en la lista de favoritos del chambeador<br>Cuando intenta guardarlo nuevamente<br>Entonces el sistema muestra un mensaje indicando que el trabajo ya fue agregado a favoritos. |
| US18 | Ver detalle de trabajo | Como chambeador, quiero visualizar el detalle completo de un turno disponible, para conocer sus condiciones antes de aceptar o postular. | Escenario 1: Detalle del trabajo visible.<br>Dado que el chambeador selecciona un trabajo disponible<br>Cuando accede al detalle del turno<br>Entonces el sistema muestra información completa como descripción, ubicación, horario, pago, requisitos y datos del contratante.<br><br>Escenario 2: Error al cargar el detalle del trabajo.<br>Dado que ocurre un fallo de conexión o el turno ya no se encuentra disponible<br>Cuando el chambeador intenta acceder al detalle del trabajo<br>Entonces el sistema muestra un mensaje de error indicando que no se pudo cargar la información. |
...
| Story ID | Título | Descripción | Criterios de Aceptación |
|----------|--------|-------------|--------------------------|
| US19 | Postular a turno | Como chambeador, quiero postular a un turno disponible, para ser considerado por el contratante y acceder a una oportunidad laboral. | Escenario 1: Postulación exitosa.<br>Dado que el turno se encuentra disponible y el chambeador cumple con los requisitos mínimos<br>Cuando el chambeador selecciona la opción de postular<br>Entonces el sistema registra la postulación y muestra un mensaje de confirmación.<br><br>Escenario 2: Postulación duplicada.<br>Dado que el chambeador ya postuló previamente al mismo turno<br>Cuando intenta postular nuevamente<br>Entonces el sistema rechaza la acción y muestra un mensaje indicando que ya existe una postulación registrada. |
| US20 | Ver postulantes | Como contratante, quiero visualizar la lista de postulantes de un turno publicado, para revisar sus perfiles y seleccionar al trabajador más adecuado. | Escenario 1: Lista de postulantes visible.<br>Dado que existen chambeadores postulados al turno<br>Cuando el contratante accede a la sección de postulantes<br>Entonces el sistema muestra la lista de postulantes con información básica como nombre, habilidades, reputación y disponibilidad.<br><br>Escenario 2: Sin postulantes registrados.<br>Dado que ningún chambeador ha postulado al turno<br>Cuando el contratante accede a la sección de postulantes<br>Entonces el sistema muestra un mensaje indicando que aún no existen postulantes. |
| US21 | Aceptar postulante | Como contratante, quiero aceptar a un postulante, para asignarlo oficialmente al turno publicado. | Escenario 1: Aceptación exitosa del postulante.<br>Dado que el turno se encuentra abierto y el postulante está disponible<br>Cuando el contratante selecciona la opción de aceptar postulante<br>Entonces el sistema asigna el turno al chambeador y actualiza el estado de la postulación como aceptada.<br><br>Escenario 2: Error al aceptar postulante.<br>Dado que el turno ya fue cerrado, cancelado o asignado previamente<br>Cuando el contratante intenta aceptar al postulante<br>Entonces el sistema rechaza la acción y muestra un mensaje indicando que el turno ya no está disponible. |
| US22 | Rechazar postulante | Como contratante, quiero rechazar a un postulante, para mantener actualizada la gestión del turno y continuar evaluando otros candidatos. | Escenario 1: Rechazo exitoso del postulante.<br>Dado que el postulante se encuentra pendiente de evaluación<br>Cuando el contratante selecciona la opción de rechazar<br>Entonces el sistema actualiza el estado de la postulación como rechazada y notifica al chambeador.<br><br>Escenario 2: Error al rechazar postulante.<br>Dado que la postulación ya fue aceptada, rechazada o modificada previamente<br>Cuando el contratante intenta rechazarla nuevamente<br>Entonces el sistema muestra un mensaje indicando que la postulación ya fue actualizada. |
| US23 | Cerrar turno | Como contratante, quiero cerrar un turno publicado, para evitar nuevas postulaciones cuando la vacante ya no esté disponible. | Escenario 1: Cierre exitoso del turno.<br>Dado que el turno se encuentra activo o publicado<br>Cuando el contratante selecciona la opción de cerrar turno<br>Entonces el sistema cambia el estado del turno a cerrado y bloquea nuevas postulaciones.<br><br>Escenario 2: Turno ya cerrado.<br>Dado que el turno ya se encuentra cerrado<br>Cuando el contratante intenta cerrarlo nuevamente<br>Entonces el sistema muestra un mensaje indicando que el turno ya fue cerrado previamente. |
| US24 | Reabrir turno | Como contratante, quiero reabrir un turno cerrado o cancelado, para volver a recibir postulaciones cuando aún necesite cubrir la vacante. | Escenario 1: Reapertura exitosa del turno.<br>Dado que el turno se encuentra cerrado o cancelado<br>Cuando el contratante selecciona la opción de reabrir turno<br>Entonces el sistema cambia el estado del turno a publicado y permite recibir nuevas postulaciones.<br><br>Escenario 2: Turno ya activo.<br>Dado que el turno ya se encuentra activo o publicado<br>Cuando el contratante intenta reabrirlo<br>Entonces el sistema rechaza la acción y muestra un mensaje indicando que el turno ya está disponible. |
| US25 | Notificación de postulaciones | Como contratante, quiero recibir notificaciones cuando un chambeador postule a mi turno, para revisar rápidamente a los candidatos interesados. | Escenario 1: Notificación enviada correctamente.<br>Dado que un chambeador realiza una nueva postulación a un turno publicado<br>Cuando la postulación se registra en el sistema<br>Entonces el sistema envía una notificación al contratante con la información básica del postulante.<br><br>Escenario 2: Error al enviar notificación.<br>Dado que ocurre una falla en el servicio de notificaciones<br>Cuando se registra una nueva postulación<br>Entonces el sistema guarda la postulación y registra el error para su revisión posterior. |
| US26 | Estado de postulación | Como chambeador, quiero consultar el estado de mis postulaciones, para saber si fui aceptado, rechazado o sigo pendiente de evaluación. | Escenario 1: Estado de postulación actualizado.<br>Dado que el contratante toma una decisión sobre la postulación<br>Cuando el chambeador accede a la sección de mis postulaciones<br>Entonces el sistema muestra el estado actualizado como pendiente, aceptado o rechazado.<br><br>Escenario 2: Error al consultar estado.<br>Dado que ocurre un fallo de conexión o carga de información<br>Cuando el chambeador intenta consultar el estado de su postulación<br>Entonces el sistema muestra un mensaje de error indicando que no se pudo cargar la información. |
| US27 | Recordatorio de turno | Como usuario, quiero recibir recordatorios antes del inicio de un turno, para llegar a tiempo y cumplir con la coordinación acordada. | Escenario 1: Recordatorio enviado correctamente.<br>Dado que el usuario tiene un turno confirmado próximo a iniciar<br>Cuando se cumple el tiempo configurado para el recordatorio<br>Entonces el sistema envía una notificación con los datos principales del turno.<br><br>Escenario 2: Recordatorio desactivado.<br>Dado que el usuario tiene desactivadas las notificaciones o recordatorios<br>Cuando se cumple el tiempo configurado para el aviso<br>Entonces el sistema no envía la notificación y respeta la configuración del usuario. |
| US28 | Confirmar llegada | Como chambeador, quiero confirmar mi llegada al lugar del turno, para registrar mi asistencia y validar el inicio de la jornada laboral. | Escenario 1: Confirmación de llegada exitosa.<br>Dado que el chambeador se encuentra dentro del horario permitido de inicio del turno<br>Cuando selecciona la opción de confirmar llegada<br>Entonces el sistema registra la asistencia y actualiza el estado del turno como iniciado.<br><br>Escenario 2: Confirmación fuera de tiempo.<br>Dado que el chambeador intenta confirmar su llegada fuera del horario permitido<br>Cuando selecciona la opción de confirmar llegada<br>Entonces el sistema muestra una alerta indicando que la confirmación está fuera del tiempo establecido. |
| US29 | Reportar problema | Como usuario, quiero reportar incidencias relacionadas con un turno, para informar problemas y solicitar revisión por parte de la plataforma. | Escenario 1: Reporte enviado correctamente.<br>Dado que el usuario completa la descripción del problema y selecciona el turno relacionado<br>Cuando envía el reporte<br>Entonces el sistema registra la incidencia y muestra un mensaje de confirmación.<br><br>Escenario 2: Reporte con datos incompletos.<br>Dado que el usuario no completa la información obligatoria del reporte<br>Cuando intenta enviar la incidencia<br>Entonces el sistema rechaza el envío y muestra un mensaje solicitando completar los datos faltantes. |
| US30 | Finalizar turno | Como usuario, quiero finalizar un turno desde la plataforma, para registrar el cierre de la actividad y permitir la calificación correspondiente. | Escenario 1: Finalización exitosa del turno.<br>Dado que el turno fue iniciado y la jornada laboral ha terminado<br>Cuando el usuario confirma la finalización del turno<br>Entonces el sistema cambia el estado del turno a finalizado y habilita la opción de calificación.<br><br>Escenario 2: Error al finalizar turno no iniciado.<br>Dado que el turno aún no fue iniciado o no tiene asistencia confirmada<br>Cuando el usuario intenta finalizarlo<br>Entonces el sistema rechaza la acción y muestra un mensaje indicando que el turno debe estar iniciado para poder finalizarse. |
